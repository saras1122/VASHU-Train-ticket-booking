          ...
          <form method="POST">
            <div class="search-bar">
              ...
              <div class="segment" id="segment2">
                <img class="image" src="./assets/images/to.png" alt="Icon 2" style="margin-left:10px">
                <div class="text-section">
          ...
          <div>
            <div>
              <div>
                ...
                <div>
                  <h4>
                    <i style="font-size:24px;color: red; rotate: skewY(90deg);" class="fa">&#xf072;</i> Departing Train
                  </h4>
                  <h3>
                      ...
                      ?>
                        <tr>
                          ...
                          <td style="width: 400px;font-size:14px;">
                            -------------------------- <?php echo $duration ?> --------------------------
                            <i style="font-size:24px;color: black; rotate: skewY(90deg);" class="fa">&#xf072;</i> <?php echo " ~ " . $travel_distance . " km" ?><br>
                          ...
                          <td style="font-size:14px;"><b>
                              <b>
                                ...
                                if ($row->seats == 0) {
                                  ...
                                  echo '<a href="pass-login.php" style="color:#f075bf;">Click here</a>';
                                }
                                ?>
                              </b>
