        ...
        <div class="main-content container-fluid">
          <div class="row">
            <div class="col-sm-12">
               ...
               */         
                $aid=$_SESSION['pass_id'];
                $ret="select * from booked where user_id=?";
                ...
                while($row=$res->fetch_object())
                 {
                    ?>
                <div class="card-header"><?php echo $row->user_fname;?> <?php echo $row->user_lname;?>  This Is Your Booked Train!   
                <?php }?>             
                </div>
                ...
                <div class="card-body">
                  <table class="table table-striped table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                         ...
                         */
                            //$aid=$_SESSION['pass_id'];
                            $ret="select * from booked where user_id=?";//sql to get details of our user
                            $stmt= $mysqli->prepare($ret) ;
                            $stmt->bind_param('i',$aid);
                            $stmt->execute() ;//ok
                            $res=$stmt->get_result();
