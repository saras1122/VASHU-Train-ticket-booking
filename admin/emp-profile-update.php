                  ...
                  <form method="POST">
                    ...
                    <div class="parentDiv" style="border-radius: 100px;">
                      <div class="childDiv leftChild" style="border-top-left-radius: 100px;border-bottom-left-radius: 100px;">
                        <img src="../assets/images/update_profile.png" alt="Image" class="center" width="200" height="200" style=" margin-top: 30px;">
                      ...
                      <div class="childDiv">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-12 col-sm-8 col-lg-6">
                            <input class="form-control" name="admin_email" value="<?php echo $row->admin_email; ?>" id="inputText3" type="email">
                          </div>
                        </div>
                        <div class="form-group row">
