...
if (isset($_POST['Update_Password'])) {
  $query = "SELECT `admin_pwd` from `admin` where `admin_id` = $aid";
  $result = $mysqli->query($query);
  if ($result && $result->num_rows > 0) {
    $row = $result->fetch_assoc();
    $pass_pwd = $row['admin_pwd'];
  }
  ...
  if ($pass_pwd == $old_pwd) {
    ...
    $query = "update admin set admin_pwd = ? where admin_id=?";
                    ...
                    <form method="POST">
                      ...
                      <div class="parentDiv" style="border-radius: 100px;">
                        ...
                        <div class="childDiv">
                          ...
                          <div class="form-group row">
                            <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3" style="margin-top: 12px;">Confirm New Password</label>
                            <div class="col-12 col-sm-8 col-lg-6">
                              <input class="form-control" name="conf_pwd" id="inputText3" type="password">
                            </div>
                          </div>
