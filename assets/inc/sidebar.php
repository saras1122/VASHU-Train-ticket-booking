<div class="be-left-sidebar" style="width: 150px;">
                ...
                <ul class="sidebar-elements">
                  ...
                  <li class="active"><a href="pass-dashboard.php"><i class="icon mdi mdi-home"></i><span>Dashboard</span></a>
                    ...
                    <?php
                      ...
                      {
                    ?>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-face"></i><span><?php echo $row->user_uname;?>'s Profile</span></a>
                    <ul class="sub-menu">
                  ...
                  <li><a href="index.php "><i class="icon mdi mdi-exit-run"></i><span>Home</span></a>
                  </li>
                </ul>
              </div>
            </div>
